...
> **Fork note:** This is [kongra/rticles](https://github.com/kongra/rticles), a personal fork of
> [rstudio/rticles](https://github.com/rstudio/rticles) that adds the
> **JACSM** (Journal of Applied Computer Science Methods) template (`jacsm_article()`).
> Install with `devtools::install_github("kongra/rticles")`.
