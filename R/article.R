...
#' @section `jacsm_article`: Format for creating Journal of Applied Computer
#'   Science Methods (JACSM) articles. Based on
#'   <https://www.degruyter.com/view/j/jacsm>.
#' @export
#' @rdname article
jacsm_article <- function(..., keep_tex = TRUE) {
  pdf_document_format("jacsm", keep_tex = keep_tex, ...)
}
